  ...
  return {
     ...
     */
      ...
      configure: function() {
        ...
        this.app.configure(utilities.objectProxy(this.app, config.all, this.components, this.middlewares))
          .configure('development', utilities.objectProxy(this.app, config.dev, this.components, this.middlewares))
          .configure('production', utilities.objectProxy(this.app, config.pro, this.components, this.middlewares));
