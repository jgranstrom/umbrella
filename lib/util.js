...
exports = module.exports = {
  ...
  buildDependancyObject: function(dir, object, process) {
    fs.readdirSync(dir).forEach(function(file) {
      if(fs.statSync(dir + file).isDirectory()) {
        object[file] = exports.buildDependancyObject(dir + file + '/', {}, process);
      } else {
  ...
  injectDependencies: function(func, umbrella) {
    var args = exports.getFunctionParameters(func),
      injectArgs = [];
  ...
  buildAndInject: function(path, umbrella) {
    return exports.buildDependancyObject(path, {}, function(object) {
      if(typeof object === 'function') return exports.injectDependencies(object, umbrella);
      else return object;
    });
  }
};